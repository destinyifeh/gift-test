      ...
      {mobileMenuOpen && (
        <div className="px-4 pb-4 bg-[var(--v2-surface)]/95 backdrop-blur-xl border-t border-[var(--v2-outline-variant)]/10">
          <div className="flex flex-col gap-1 py-2">
            {isLoggedIn && (
              <Link href="/dashboard" className="px-4 py-3 rounded-xl text-[var(--v2-on-surface)] hover:bg-[var(--v2-surface-container-low)] transition-colors" onClick={() => setMobileMenuOpen(false)}>
                Dashboard
              </Link>
            )}
            ...
            <Link href="/send-gift" className="px-4 py-3 rounded-xl text-[var(--v2-on-surface)] hover:bg-[var(--v2-surface-container-low)] transition-colors">
              Send Gift
            </Link>
            <div className="border-t border-[var(--v2-outline-variant)]/10 my-2"></div>
            <Link href="/create-campaign" className="px-4 py-3 rounded-xl v2-gradient-primary text-white font-semibold text-center">
              Start Campaign
            </Link>
          </div>
        </div>
