          ...
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold font-display text-foreground mb-4">
                Integrate Gifting Into{' '}
                <span className="text-gradient">Your Platform</span>
              </h1>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Let your users send and receive gifts without building payment
                infrastructure. Earn revenue on every transaction.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Widget, SDK, or full API — integrate in minutes',
                },
                {
                  icon: DollarSign,
                  title: 'Revenue Share',
                  desc: 'Earn on every gift transaction on your platform',
                },
                {
                  icon: Palette,
                  title: 'White-Label Option',
                  desc: 'Full branding control — your name, your colors',
                },
              ].map(b => (
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      <tr className="border-b border-border">
                        <td className="py-2 text-foreground">User pays</td>
                        <td className="py-2 text-right font-semibold text-foreground">
                          $50.00
                        </td>
                      </tr>
                      <tr className="border-b border-border">
                        <td className="py-2 text-foreground">Gifthance fee</td>
              ...
              <Card className="border-accent/30 bg-accent/5">
                <CardContent className="p-6">
                  <h3 className="font-semibold text-foreground mb-1 flex items-center gap-2">
                    <Crown className="w-4 h-4 text-accent" /> White-Label
                  </h3>
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground mb-4">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-3.5 h-3.5 text-secondary" />{' '}
                      Remove all Gifthance branding
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-3.5 h-3.5 text-secondary" />{' '}
                      Custom name, logo, and colors
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-3.5 h-3.5 text-secondary" />{' '}
                      Higher API limits
            ...
            <div className="mt-16 text-center">
              ...
              <p className="text-muted-foreground mb-8">
                From signup to live integration in 4 steps
              </p>
                ...
                {[
                  {
                    step: 1,
                    title: 'Sign Up',
                    desc: 'Register as a platform partner',
                  },
                  {
                    step: 2,
                    title: 'Get API Keys',
                    desc: 'Generate public & secret keys',
                  },
                  {
                    step: 3,
                    title: 'Integrate',
                    desc: 'Add widget, SDK, or API',
                  },
                  {
                    step: 4,
                    title: 'Earn Revenue',
                  ...
                  <div key={s.step} className="text-center">
                    <div className="w-10 h-10 rounded-full bg-gradient-hero text-primary-foreground font-bold text-lg flex items-center justify-center mx-auto mb-3">
                      {s.step}
                    </div>
            ...
            <Card className="border-border mt-12">
              <CardContent className="p-6">
                <h3 className="font-semibold text-foreground mb-2">
                  Important: Partner Platform Users
                </h3>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>
                    • Users created via the partner API exist only in the
                    context of the partner platform.
                  </li>
                  <li>• They cannot log in to Gifthance.com directly.</li>
                  <li>
                    • Gifts and funds are managed through the partner platform.
                  </li>
                  <li>
                    • Payouts to partner users are processed through the
                    partner's configured payout method.
                  </li>
                </ul>
              </CardContent>
            </Card>
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Manage your integration, users, and revenue
              </p>
            </div>
                ...
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <code className="block bg-muted rounded-lg px-4 py-3 font-mono text-sm text-foreground mt-1">
                        pk_live_9384kdj3f8a7b6c5d
                      </code>
                    </div>
                    <div>
                      <Label className="text-xs text-muted-foreground">
            ...
            <TabsContent value="revenue">
              <Card className="border-border">
                <CardContent className="p-6">
                  ...
                  <Button variant="hero">
                    <ArrowRight className="w-4 h-4 mr-2" /> Request Payout
                  </Button>
                </CardContent>
              </Card>
            </TabsContent>
                ...
                <CardContent className="p-6 space-y-5">
                  ...
                  <div className="border-t border-border pt-4 space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input placeholder="Community Gifts" />
                    </div>
                    <div className="space-y-2">
                      <Label>Primary Color</Label>
                      <Input placeholder="#FF5500" />
                    </div>
                    <div className="space-y-2">
                      <Label>Logo URL</Label>
                      <Input placeholder="https://yourplatform.com/logo.png" />
                    </div>
                  </div>
