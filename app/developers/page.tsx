...
const codeSnippets = {
  widget: `<!-- Gifthance Widget -->
<script src="https://cdn.gifthance.com/widget.js"></script>
<div id="gift-widget" data-key="YOUR_API_KEY"></div>`,
  react: `npm install @gifthance/react

import { GiftButton } from '@gifthance/react';
...
function App() {
  ...
  reactNative: `npm install @gifthance/react-native

import { GiftModal } from '@gifthance/react-native';
...
import 'package:gifthance/gifthance.dart';

final gt = Gifthance(apiKey: 'YOUR_API_KEY');
await gt.sendGift(
  recipientId: 'user_123',
  amount: 25.00,
);`,
  api: `curl -X POST https://api.gifthance.com/v1/campaigns \\
...
const docSections = [
  {
    ...
    items: [
      ...
      },
      {
        name: 'API Keys',
        content:
          'API keys are scoped to your account. You can have multiple keys for different environments.\n\nTypes:\n- Live keys (gh_live_*): For production use\n- Test keys (gh_test_*): For development and testing\n\nManage keys from Dashboard → Integrations.',
      },
      {
        name: 'Quick Start Guide',
        content:
          "1. Sign up and get your API key\n2. Install the SDK for your platform\n3. Initialize with your API key\n4. Create your first gift or campaign\n\nExample:\nconst gt = new Gifthance({ apiKey: 'gh_live_xxx' });\nawait gt.createGift({ amount: 25, recipient: 'user@email.com' });",
      },
      {
        name: 'Rate Limits',
        content:
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold font-display text-foreground mb-6">
              Build with <span className="text-gradient">Gifthance</span>
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Integrate our gifting infrastructure into your own applications,
              websites, or platforms using our robust API and SDKs.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Embed a gifting widget on any website in minutes',
              },
              {
                icon: Code,
                title: 'React SDK',
                desc: 'Full React components and hooks for web apps',
              },
              {
                icon: Smartphone,
                title: 'React Native SDK',
                desc: 'Native SDK for iOS and Android mobile apps',
              },
              {
                icon: Puzzle,
                title: 'Flutter Package',
                desc: 'Dart package for Flutter mobile applications',
              },
            ].map(item => (
              <Card
                key={item.title}
          ...
          <div className="mt-16">
            ...
            <p className="text-muted-foreground text-center mb-8">
              Everything you need to integrate Gifthance into your platform.
            </p>
            ...
            <Card className="border-primary/20 bg-primary/5">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
                  Integrate Gifthance's gifting infrastructure into your
                  platform. Earn revenue share on every transaction.
                </p>
                <Link href="/platforms">
