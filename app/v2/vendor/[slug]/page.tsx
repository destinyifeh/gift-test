...
const navLinks = [
  {label: 'Shop', href: '/v2/gift-shop', active: true},
  {label: 'Occasions', href: '/v2/occasions'},
  {label: 'Registry', href: '/v2/registry'},
  {label: 'Corporate', href: '/v2/corporate'},
];

const mobileNavItems = [
  {icon: 'explore', label: 'Explore', href: '/v2'},
  {icon: 'search', label: 'Search', href: '/v2/search'},
  {icon: 'favorite', label: 'Saved', href: '/v2/favorites'},
  {icon: 'wallet', label: 'Cart', href: '/v2/cart'},
];

const footerLinks = {
  quickLinks: [
    {label: 'About Us', href: '/v2/about'},
    {label: 'Vendor Portal', href: '/v2/vendors'},
    {label: 'Gift Registry', href: '/v2/registry'},
    {label: 'Corporate Gifting', href: '/v2/corporate'},
  ],
  support: [
    {label: 'Help Center', href: '/v2/help'},
    {label: 'Contact Support', href: '/v2/contact'},
    {label: 'Refund Policy', href: '/v2/refunds'},
    {label: 'Shipping Info', href: '/v2/shipping'},
  ],
};
    ...
    <div className="min-h-screen bg-[var(--v2-background)]">
      ...
      <main className="pt-24 pb-32 md:pb-12 max-w-7xl mx-auto px-6">
        ...
        <nav className="flex items-center gap-2 mb-8 text-[var(--v2-on-surface-variant)] text-sm font-medium">
          ...
          <Link href="/v2/vendors" className="hover:text-[var(--v2-primary)]">
            Vendors
          </Link>
          <span className="v2-icon text-xs">chevron_right</span>
