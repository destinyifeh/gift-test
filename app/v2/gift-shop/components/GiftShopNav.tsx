    ...
    <nav className="fixed top-0 w-full z-50 bg-orange-50/80 backdrop-blur-xl hidden md:block">
      <div className="flex justify-between items-center px-8 py-4 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-6">
          ...
          {isLoggedIn ? (
            <Link href="/v2/dashboard" className="flex items-center text-orange-700 hover:opacity-80 duration-200">
              <span className="v2-icon text-2xl">account_circle</span>
            </Link>
          ) : (
            <Link href="/v2/login" className="text-orange-700 font-semibold">
              Login
            </Link>
          )}
        </div>
