...
export default function ClaimFlexCardPage() {
  ...
  const handleClaim = async () => {
    ...
    if (result.success) {
      ...
      router.push('/v2/dashboard?tab=my-gifts');
    } else {
      ...
      <div className="min-h-screen bg-[var(--v2-background)] flex flex-col">
        ...
        <main className="flex-1 flex flex-col items-center justify-center p-4">
          <div className="w-full max-w-md text-center">
            ...
            <Link
              href="/v2/dashboard?tab=my-gifts"
        ...
        <main className="flex-1 flex flex-col items-center justify-center p-4">
          <div className="w-full max-w-md">
            ...
            <div className="space-y-3">
              <Link
                href={`/v2/login?redirect=/v2/claim/flex/${params.code}${flexCard.recipient_email ? `&email=${flexCard.recipient_email}` : ''}`}
                className="block"
              >
              ...
              <Link
                href={`/v2/signup?redirect=/v2/claim/flex/${params.code}${flexCard.recipient_email ? `&email=${flexCard.recipient_email}` : ''}`}
                className="block"
              >
