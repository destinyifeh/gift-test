...
export function V2AdminSettingsTab() {
  ...
  const profileMutation = useMutation({
    mutationFn: (updates: {display_name?: string; bio?: string}) => updateProfile(updates),
    ...
    <div className="space-y-8">
        ...
        <div className="divide-y divide-[var(--v2-surface-container)]">
          ...
          <div className="px-8 py-5 flex items-center justify-between">
            ...
            <button
              ...
              className={`w-14 h-8 rounded-full transition-colors relative ${
                settings.maintenanceMode ? 'bg-[var(--v2-error)]' : 'bg-[var(--v2-surface-container)]'
              }`}>
              <span
          ...
          <div className="px-8 py-5 flex items-center justify-between">
            ...
            <button
              ...
              className={`w-14 h-8 rounded-full transition-colors relative ${
                settings.newRegistrations ? 'bg-emerald-500' : 'bg-[var(--v2-surface-container)]'
              }`}>
              <span
                className={`absolute top-1 w-6 h-6 bg-white rounded-full shadow transition-all ${
                  settings.newRegistrations ? 'right-1' : 'left-1'
                }`}
              />
            </button>
          </div>
          ...
          <div className="px-8 py-5 flex items-center justify-between">
            ...
            <button
              ...
              className={`w-14 h-8 rounded-full transition-colors relative ${
                settings.vendorApplications ? 'bg-emerald-500' : 'bg-[var(--v2-surface-container)]'
              }`}>
              <span
                className={`absolute top-1 w-6 h-6 bg-white rounded-full shadow transition-all ${
                  settings.vendorApplications ? 'right-1' : 'left-1'
                }`}
              />
            </button>
          </div>
          ...
          <div className="px-8 py-5 flex items-center justify-between">
            ...
            <button
              ...
              className={`w-14 h-8 rounded-full transition-colors relative ${
                settings.emailNotifications ? 'bg-emerald-500' : 'bg-[var(--v2-surface-container)]'
              }`}>
              <span
                className={`absolute top-1 w-6 h-6 bg-white rounded-full shadow transition-all ${
      ...
      <div className="flex justify-end">
        <button
          ...
          className="px-8 py-3 v2-hero-gradient text-white rounded-full font-bold shadow-lg shadow-[var(--v2-primary)]/20 hover:opacity-90 transition-opacity">
