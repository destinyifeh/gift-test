      ...
      <main className="pt-14 md:pt-24 pb-32 md:pb-16 px-4 min-h-screen flex items-center justify-center">
        <div className="max-w-md w-full text-center">
          ...
          <div className="space-y-3">
            <Link href="/login" className="w-full h-14 v2-hero-gradient text-[var(--v2-on-primary)] font-bold rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-[var(--v2-primary)]/20 active:scale-[0.98] transition-all">
              <span className="v2-icon">login</span>
              Login
            </Link>
            <Link href="/signup" className="w-full h-14 bg-[var(--v2-surface-container-low)] text-[var(--v2-on-surface)] font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-[var(--v2-surface-container-high)] transition-colors active:scale-[0.98]">
