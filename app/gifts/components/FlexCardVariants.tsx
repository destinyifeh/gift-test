  ...
  const getContainerStyle = () => {
      switch(variant) {
          ...
          case 'dynamic':
              if (dynamicStyle) {
                  return { 
                      background: dynamicStyle.colorMiddle
                          ? `linear-gradient(135deg, ${dynamicStyle.colorFrom}, ${dynamicStyle.colorMiddle}, ${dynamicStyle.colorTo})`
                          : `linear-gradient(135deg, ${dynamicStyle.colorFrom}, ${dynamicStyle.colorTo})`
                  };
              }
