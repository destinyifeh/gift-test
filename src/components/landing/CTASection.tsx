          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <Link to="/create-campaign">
                <Button size="lg" className="bg-background text-foreground hover:bg-background/90 font-semibold text-base px-8 shadow-elevated w-full sm:w-auto">
                  <Gift className="w-5 h-5 mr-2" />
                  Start a Campaign
                </Button>
              </Link>
              <Link to="/gift-shop">
                <Button size="lg" variant="outline" className="border-2 border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 font-semibold text-base px-8 w-full sm:w-auto">
