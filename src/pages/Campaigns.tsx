...
import { Search, Users, Clock, Plus, Globe } from "lucide-react";
      ...
      <div className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8 max-w-2xl mx-auto">
            ...
            <Link to="/create-campaign"><Button variant="hero"><Plus className="w-4 h-4 mr-1" /> Create</Button></Link>
          </div>
                  ...
                  <Card className="border-border hover:shadow-elevated hover:border-primary/30 transition-all cursor-pointer h-full">
                    <CardContent className="p-5">
                      ...
                      <div className="flex justify-between text-sm mb-2">
                        <span className="font-bold text-foreground">${c.raised} <span className="font-normal text-muted-foreground">of ${c.goal}</span></span>
                        <span className="text-muted-foreground">{Math.round((c.raised / c.goal) * 100)}%</span>
                      </div>
