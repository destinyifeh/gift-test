    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-1">Start gifting and celebrating in minutes</p>
        </div>
          ...
          <CardContent className="p-6 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="username" value={username} onChange={(e) => setUsername(e.target.value)} placeholder="destiny" className="pl-8" />
              </div>
              <p className="text-xs text-muted-foreground">Your permanent link: gifttogether.com/{username || "username"}</p>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="password" type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Minimum 8 characters" className="pl-10 pr-10" />
