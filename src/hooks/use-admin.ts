      ...
      return {
        ...
        data: res.data.data.map((g: any) => ({
          ...
          profiles: g.user ? {
            ...
            business_name: g.user.businessName,
            business_address: g.user.businessAddress,
          } : null,
        })),
      };
    },
    ...
    queryFn: async ({ pageParam = 1 }) => {
      ...
      return {
        ...
        data: res.data.data.map((p: any) => ({
          ...
          vendor: p.vendor ? { ...p.vendor, display_name: p.vendor.displayName, business_name: p.vendor.businessName } : null,
