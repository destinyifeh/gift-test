...
const giftCards = [
  ...
  // ── Everyday Use ──
  { name: 'Groceries Card', slug: 'groceries-card', description: 'For your everyday needs.', category: 'everyday', icon: 'shopping_basket', colorFrom: '#0891B2', colorTo: '#0E7490', amountOptions: [5000, 10000, 25000, 50000], usageDescription: 'Redeemable at supermarkets and grocery stores', status: 'active', displayOrder: 8 },
